...
<body leftmargin="0" marginwidth="0" topmargin="0" marginheight="0" offset="0">
	<center>
    	<table id="bgTable" border="0" cellpadding="0" cellspacing="0" height="100%" width="100%">
			...
			<tr>
				<td align="center" valign="top" style="border: 0 none;">					
					<table id="main" border="0" cellpadding="0" cellspacing="0"  width="600">		
						<tr>
							<td align="center" valign="top" style="border: 0 none;">
								<table id="main" border="0" cellpadding="10" cellspacing="0"  width="300">
									<tbody class="items">
										<tr>
											<td class="item">
			...
			<tr>
				<td align="center" valign="top" style="border: 0 none;">					
					<table id="main" border="0" cellpadding="10" cellspacing="0"  width="600">
						<tbody class="items">
							<tr><td class="item">
								<div style="width: 560px;">
									<h2 class="editable">Heading</h2>
									<p class="editable">Body text</p>
								</div>
							</td></tr>
